...
class MCPClient {
  ...
  private async mockToolCall(call: MCPToolCall): Promise<MCPToolResult> {
    ...
    switch (tool) {
      ...
      case "detect_clashes":
        return this.mockDetectClashes(args);
      case "detect_clashes_between_sets":
        return this.mockDetectClashesBetweenSets(args);
      default:
        return {
          success: false,
          error: {
  ...
  private mockDetectClashes(args: Record<string, unknown>): MCPToolResult {
  ...
  private mockDetectClashesBetweenSets(
